...
def main():
    ...
    metrics_per_se = {se_idx: {"ap": .0, "auc-roc": .0, "auc-pr": .0, "Ap@50": .0} for se_idx in pse_indices}
    ...
    for se in tqdm(pse_indices, desc="Evaluating test data for each side-effect"):
        ...
        print("AP: %1.4f - AUC-ROC: %1.4f - AUC-PR: %1.4f - AP@50: %1.4f ---------> %s" %
              (se_ap, se_auc_roc, se_auc_pr, se_p50, se_code), flush=True)
